...
def MolToImage(mol, max_size=(400, 400), kekulize=True, options=None,
               canvas=None, three_D=False, **kwargs):
...
def ReactionStringToImage(rxn_string, strip=False, update=True, options=None,
        retro=False, three_D=False, **kwargs):
    ...
    # Generate images
    imgs = [TrimImgByWhite(MolToImage(
        mol, kekulize=True, options=options, three_D=three_D), padding=10) for mol in mols]
